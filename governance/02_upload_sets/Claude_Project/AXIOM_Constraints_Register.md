...
**Baseline RAM consumption during predecessor-system operation (legacy reference):** approximately 5.7 GB  
...
| Virtual environment | venv at C:\axiom\venv\ |
| Local model server | Ollama |
| Local embedding model | nomic-embed-text |
| Local language model | qwen3:4b (thinking disabled) |
| Database | SQLite database filename pending AXIOM rebuild |
