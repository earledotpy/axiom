...
**Constraints Register is binding.** Before approving any proposal, verify it is feasible on the hardware defined in the Constraints Register. If it requires hardware not listed there, flag it immediately. The Runtime Invariants (B1–B22) in the Constraints Register are not open to challenge without a Charter-grade amendment.
