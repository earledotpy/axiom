...
**Status:** Active — Ratified under Charter v1.1
**Version:** 1.1
**Scope:** All factual rulings and binding conditions currently in force across the AXIOM design
**Ratification Cycle:** Ratified Cycle 3, 2026-05-10 by `AXIOM_Synthesis_Governance_v3.md`
...
*AXIOM Active Bindings — Version 1.1 — May 2026 — bindings now operate under Charter v1.1 governance rules. Binding set unchanged from v1.0.*
