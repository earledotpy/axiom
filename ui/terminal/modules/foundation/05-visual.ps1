...
function Write-AxiomStartupBanner {
    ...
    Write-Host "$($a.Dim) next:    $($a.Soft)state$($a.Reset)  $($a.Dim)|$($a.Reset)  $($a.Soft)cycle$($a.Reset)  $($a.Dim)|$($a.Reset)  $($a.Soft)next$($a.Reset)  $($a.Dim)|$($a.Reset)  $($a.Soft)axiom-help$($a.Reset)"
    Write-Host ""
}
